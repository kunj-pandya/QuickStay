...
const RoomDetails = () => {
  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      {/* Room Details */}
      <div className='flex flex-col md:flex-row items-start md:start-center gap-2'>
        <h1 className='text-3xl md:start-4xl font-playfair'>{room.hotel.name}<span className='font-inter text-sm'>({room.roomType})</span></h1>
      ...
      {/* Room Images */}
        ...
        <div className='mt-25 space-y-4'>{roomCommonData.map((spac, index) => (
